...
int main(int argc, char** argv)
{
    ...
    Point2f img2_coord[4] = { Point2f(216, 144), Point2f(276, 141), Point2f(246, 210), Point2f(244, 178) }; // координаты на втором изображении
    ...
    int steps = 100; // итерации
    float weight = (float)1 / (float)steps; // вес
